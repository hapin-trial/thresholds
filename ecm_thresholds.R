...
bl_shift_threshold <- 10

neph_neg_threshold <- 10
neph_neg_magnitude_threshold <- -10
...
window_width <- 20
overall_compliance_threshold <- 0.4 #If more than this fraction of samples is not categorize as being compliant, run is flagged.  Includes nighttime data.
